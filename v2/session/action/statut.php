    ...
    <body >
                <?php
                    ...
                    if ($result1 == false){
                        ...
                        if($l['pro_statut']=='G'){
                            $requete2="UPDATE T_PROFIL_PRO SET pro_statut='M' WHERE com_pseudo='".$pseudo_choisi."';";
                        }
                        else{
                            $requete2="UPDATE T_PROFIL_PRO SET pro_statut='G' WHERE com_pseudo='".$pseudo_choisi."';";
                        }
